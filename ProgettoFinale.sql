...
CREATE TABLE Ruolo(
    Tipo_ruolo TEXT NOT NULL CHECK (
        Tipo_ruolo IN ('Docente', 'Referente', 'Rilevatore Esterno')
    ),
);
CREATE TABLE Classe(
...
CREATE TABLE Specie(
    ...
    substrato TEXT NOT NULL CHECK (
        substrato IN ('Terriccio rinvaso', 'Suolo pre-esistente')
    ),
...
CREATE TABLE Rilevazioni(
    ...
    fruttificazione
    /* entità con tuttii dati del' excel*/
    danni
    /* entità con tuttii dati del' excel*/
    biomassa
    /* entità con tuttii dati del' excel*/
    ...
    CONSTRAINT data_ora_rilevazione_a_antecedente_a_data_ora_inserimento CHECK (data_ora_rilevazione > data_ora_inserimento),
...
--Classe
INSERT INTO Classe
VALUES ('1A', 'Nicola584@gmail.com,', 'Superiore', 'Liceo');
INSERT INTO Classe
VALUES ('2A', 'Laura659@gmail.com,', 'Superiore', 'Liceo');
INSERT INTO Classe
VALUES ('3A', 'Siria7854@.gmail.com', 'Superiore', 'Liceo');
INSERT INTO Classe
VALUES ('4A', 'Ugo456@gmail.com', 'Superiore', 'Liceo');
--Orto
INSERT INTO Orto
VALUES ('Orto1', '100mq', 44.40726, 8.93386, 'OK', 'Vaso');
INSERT INTO Orto
VALUES ('Orto2', '100mq', 44.40726, 8.93386, 'OK', 'Terra');
INSERT INTO Orto
VALUES ('Orto3', '100mq', 44.40726, 8.93386, 'OK', 'Vaso');
INSERT INTO Orto
VALUES ('Orto4', '100mq', 44.40726, 8.93386, 'OK', 'Terra');
--Piante
INSERT INTO Piante
VALUES (
        '1',
...
VALUES (1, 'arduino', 'BD');
INSERT INTO Sensore
VALUES (2, 'sensore', 'App');
INSERT INTO Sensore
VALUES (3, 'arduino', 'BD');
INSERT INTO Sensore
VALUES (4, 'sensore', 'App');
--Info_Ambientali
INSERT INTO Info_Ambientali
VALUES ('HWID1', 7, 25, 50, 'arduino', 1, 'BD');
INSERT INTO Info_Ambientali
VALUES ('HWID2', 7, 25, 50, 'sensore', 2, 'App');
INSERT INTO Info_Ambientali
VALUES ('HWID3', 7, 25, 50, 'arduino', 3, 'BD');
INSERT INTO Info_Ambientali
VALUES ('HWID4', 7, 25, 50, 'sensore', 4, 'App');