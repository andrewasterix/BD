...
CREATE TABLE Rilevazioni(
    ...
    pianta REFERENCES Pianta(id_pianta),
    biomassa REFERENCES Biomassa(id_biomassa),
    fruttificazione REFERENCES Fruttificazione(id_fruttificazione),
    danni REFERENCES Danni(id_danni),
    parametri REFERENCES Parametri(id_parametri),
